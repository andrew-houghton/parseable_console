...
import { ConfigHeader, LogsHeader, QueryHeader, StatsHeader, UsersManagementHeader, BetterLogsHeader } from './SubHeader';
import { CONFIG_ROUTE, LOGS_ROUTE, QUERY_ROUTE, STATS_ROUTE, USERS_MANAGEMENT_ROUTE, BETTER_LOGS_ROUTE } from '@/constants/routes';
	...
	return (
		<Routes>
			<Route element={<HeaderLayout {...props} />}>
				<Route path={BETTER_LOGS_ROUTE} element={<BetterLogsHeader />} />
